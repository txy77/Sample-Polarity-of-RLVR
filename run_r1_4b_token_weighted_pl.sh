...
export token_weighted_metric="entropy" # prob / entropy
...
python3 -m verl.trainer.main_ppo \
      ...
      algorithm.token_weighted_positive_low_num_ratio=${token_weighted_positive_low_num_ratio} \
      algorithm.token_weighted_positive_low_scale=${token_weighted_positive_low_scale} \
