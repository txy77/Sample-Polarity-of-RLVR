...
# export token_weighted_positive_low_num_ratio: null # positive low num ratio
# export token_weighted_positive_low_scale: null # positive low scale
# export token_weighted_negative_high_num_ratio: null # negative high num ratio
# export token_weighted_negative_high_scale: null # negative high scale
# export token_weighted_negative_low_num_ratio: null # negative low num ratio
# export token_weighted_negative_low_scale: null # negative low scale
...
python3 -m verl.trainer.main_ppo \
      ...
      algorithm.token_weighted_positive_high_num_ratio=${token_weighted_positive_high_num_ratio} \
      algorithm.token_weighted_positive_high_scale=${token_weighted_positive_high_scale} \
